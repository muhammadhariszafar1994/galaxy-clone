...
function PasswordUpdatedSuccessfully(): React.JSX.Element {
                ...
                <View style={styles.cardContainer}>
                    ...
                    >
                        ...
                        <View style={styles.typoContainer}>
                            <Text style={styles.typoTitle}>Password Updated Successfully</Text>
                            <Text style={styles.typoPara}>Your password has been changed. Please use {"\n"} your new password the next time you log in.</Text>
                        </View>
